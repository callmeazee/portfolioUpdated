...
| ISS-044 | Besties repository is private | 🟡 | High | `github.com/callmeazee/besties` returns 404 unauthenticated. Its case study cannot be derived the way Snitcher's was — make it public, or supply the stack, data model and call flow directly |
